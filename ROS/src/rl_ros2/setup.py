...
setup(
    ...
    entry_points={
        'console_scripts': [
            'rl_obs = rl_ros2.rl_obs:main',
            'rl_policy = rl_ros2.rl_policy:main',
            'rl_action = rl_ros2.rl_action:main',
            'flight_recorder = rl_ros2.flight_recorder:main',
            'teleop = rl_ros2.teleop:main',
        ],
    },
)
