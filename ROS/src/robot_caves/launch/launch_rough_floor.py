...
def generate_launch_description():
    ...
    world_file = os.path.join(pkg_share, 'worlds', 'rough_floor.sdf')
    ...
    # NOTE: Adjust z to clear the highest terrain feature in rough_floor.sdf
    spawn_robot = Node(
        package='ros_gz_sim',
        executable='create',
        arguments=[
    ...
    # NOTE: No ceiling mapper — rough_floor.sdf is an open environment
    floor_mapping = Node(
