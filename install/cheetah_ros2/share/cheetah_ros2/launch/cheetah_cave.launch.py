...
def generate_launch_description():
    ...
    contact_bridge = Node(
        ...
        executable='parameter_bridge',
        arguments=[
            '/world/cave_world/model/THex_Quadruped/link/fl_foot/sensor/fl_contact/contact@ros_gz_interfaces/msg/Contacts[gz.msgs.Contacts',
            '/world/cave_world/model/THex_Quadruped/link/fr_foot/sensor/fr_contact/contact@ros_gz_interfaces/msg/Contacts[gz.msgs.Contacts',
            '/world/cave_world/model/THex_Quadruped/link/bl_foot/sensor/bl_contact/contact@ros_gz_interfaces/msg/Contacts[gz.msgs.Contacts',
            '/world/cave_world/model/THex_Quadruped/link/br_foot/sensor/br_contact/contact@ros_gz_interfaces/msg/Contacts[gz.msgs.Contacts'
        ],
        remappings=[
            ('/world/cave_world/model/THex_Quadruped/link/fl_foot/sensor/fl_contact/contact', '/contact/fl'),
            ('/world/cave_world/model/THex_Quadruped/link/fr_foot/sensor/fr_contact/contact', '/contact/fr'),
            ('/world/cave_world/model/THex_Quadruped/link/bl_foot/sensor/bl_contact/contact', '/contact/bl'),
            ('/world/cave_world/model/THex_Quadruped/link/br_foot/sensor/br_contact/contact', '/contact/br')
        ],
        output='screen'
    )
