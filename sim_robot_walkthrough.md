...
The function [inv_kin(x, y, z, leg_ind)](ROS/src/sim_robot/sim_robot/kinematics.py#L37-L93) computes this:
...
**File:** [kinematics.py — generate_trajectory()](ROS/src/sim_robot/sim_robot/kinematics.py#L110-L137)
...
**File:** [kinematics.py — rotate_trajectory()](ROS/src/sim_robot/sim_robot/kinematics.py#L139-L161)
...
**File:** [kinematics.py — shift_trajectory()](ROS/src/sim_robot/sim_robot/kinematics.py#L163-L186)
...
**File:** [kinematic_gait.py](ROS/src/sim_robot/sim_robot/kinematic_gait.py)
...
|------|---------|-------------|
| [model.sdf](ROS/src/sim_robot/models/THex_Quadruped/model.sdf) | Robot definition — links, joints, sensors, PID controllers | 13 links, 12 joints, 0.9414 N⋅m max torque |
| [friction_world.sdf](ROS/src/sim_robot/worlds/friction_world.sdf) | Simulation world — ground, physics, lighting | 1000 Hz physics, μ=0.7 friction |
| [ros_gz_bridge.yaml](ROS/src/sim_robot/config/ros_gz_bridge.yaml) | Topic translation map between ROS ↔ Gazebo | 26 bridged topics |
| [kinematics.py](ROS/src/sim_robot/sim_robot/kinematics.py) | Trajectory generation + inverse kinematics | 4-bar linkage, 20 waypoints/cycle |
| [kinematic_gait.py](ROS/src/sim_robot/sim_robot/kinematic_gait.py) | Main ROS 2 node — orchestrates walking | 10 Hz control, 12 publishers, 13 subscribers |
| [start_world.launch.py](ROS/src/sim_robot/launch/start_world.launch.py) | Launch file — starts Gazebo + bridge + robot | Spawns at z=0.3m |
